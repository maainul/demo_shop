...
{$('body').off('uabb-trigger.'+hook,callback);},};})(jQuery);jQuery(document).ready(function($){var uabb_browser=bowser.name,uabb_browser_v=bowser.version,uabb_browser_class=uabb_browser.replace(/\s+/g,'-').toLowerCase(),uabb_browser_v_class=uabb_browser_class+parseInt(uabb_browser_v);$('html').addClass(uabb_browser_class).addClass(uabb_browser_v_class);});var wpAjaxUrl='http://localhost/demo_shop/wp-admin/admin-ajax.php';var flBuilderUrl='http://localhost/demo_shop/wp-content/plugins/beaver-builder-lite-version/';var FLBuilderLayoutConfig={anchorLinkAnimations:{duration:1000,easing:'swing',offset:100},paths:{pluginUrl:'http://localhost/demo_shop/wp-content/plugins/beaver-builder-lite-version/',wpAjaxUrl:'http://localhost/demo_shop/wp-admin/admin-ajax.php'},breakpoints:{small:480,medium:768},waypoint:{offset:80}};(function($){if(typeof FLBuilderLayout!='undefined'){return;}
